...
class AsTypePretty extends AsType {
  get a() {
    return this.array;
  }
...
const callAsTypePretty = function(that, options) {
  return new AsTypePretty(that, options);
};

module.exports = callAsTypePretty;

module.exports.as = callAs;

module.exports.asType = callAsType;

module.exports.asTypePretty = callAsTypePretty;

module.exports.As = As;

module.exports.AsType = AsType;

module.exports.AsTypePretty = AsTypePretty;
